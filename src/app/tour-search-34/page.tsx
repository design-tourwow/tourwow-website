...
export default function TourSearch32() {
  ...
  return (
    <div className="ts32-container">
        ...
        <div className="flex gap-3">
          <div className="flex-1 relative" data-search-container="true">
            ...
            <input
              ...
              type="text"
              placeholder="ทัวร์โอซาก้า หน้าหนาว"
            ...
            />
            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 rounded-lg transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center hover:bg-gray-100 text-gray-600" aria-label="ค้นหาด้วยเสียง">
          ...
          <button className="text-blue-600 hover:text-blue-700 transition-colors duration-200 text-sm font-medium border-2 border-gray-300 rounded-xl hover:border-blue-600 bg-white relative flex items-center justify-center" style={{height: '68px', minWidth: '68px'}}>
      ...
      <section className={`px-4 py-6 ${showAdvancedModal ? 'hidden' : ''}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {[
            ...
            { 
              ...
              cities: [
                { name: 'เจนีวา', price: '฿55,900' },
                { name: 'ซูริก', price: '฿57,900' },
                { name: 'เบิร์น', price: '฿54,900' },
                { name: 'อินเทอร์ลากเคน', price: '฿59,900' }
              ]
            },
            { 
              name: 'ไอซ์แลนด์',
              ...
              cities: [
                { name: 'เรคยาวิค', price: '฿65,900' },
                { name: 'อากูเรย์รี', price: '฿63,900' },
                { name: 'โฮฟน์', price: '฿67,900' }
              ]
            }
          ].map((country, idx) => (
            <div
              ...
              <div className="p-4 bg-white">
                ...
                <div className="mt-4 text-center">
                  ...
                  >
                    ...
                    <svg 
                      className={`w-4 h-4 transition-transform ${expandedCountries[country.name] ? 'rotate-180' : ''}`} 
                      fill="currentColor" 
                      viewBox="0 0 20 20"
                    >
      ...
      <section className={`ts32-popular-destinations ${showAdvancedModal ? 'hidden' : ''}`} style={{ marginTop: '2rem' }}>
        ...
        <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 snap-x snap-mandatory md:snap-none">
          <button className="group flex-shrink-0 w-80 md:w-auto bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden snap-center md:snap-align-none">
            <div className="relative h-44 md:h-48 overflow-hidden">
              ...
              <div className="absolute bottom-3 left-3 right-3">
                <h4 className="text-white text-lg font-bold mb-1 drop-shadow-lg">ญี่ปุ่น ซากุระ</h4>
          ...
          <button className="group flex-shrink-0 w-80 md:w-auto bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden snap-center md:snap-align-none">
            <div className="relative h-44 md:h-48 overflow-hidden">
              ...
              <div className="absolute bottom-3 left-3 right-3">
                <h4 className="text-white text-lg font-bold mb-1 drop-shadow-lg">ไต้หวัน Street Food</h4>
