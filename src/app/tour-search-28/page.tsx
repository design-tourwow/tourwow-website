...
export default function TourSearch27() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Popular Countries - Mobile First Card Grid Design */}
      <div className="px-3 py-4 md:px-6 md:py-6">
        <div className="mb-6 md:mb-8">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-3">
              <span>🌍</span>
              <span>จุดหมายยอดนิยม</span>
            </div>
            <h2 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">เลือกประเทศที่คุณฝัน</h2>
            <p className="text-gray-600 text-sm md:text-base">สำรวจจุดหมายที่นักเดินทางทั่วโลกหลงใหล</p>
          </div>
          
          {/* Mobile First: Single Column, Desktop: 2-3 Columns */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              { 
                ...
                highlights: ['ซากุระ', 'รามเทพ', 'โตเกียว', 'เกียวโต'],
              ...
              { 
                ...
                highlights: ['K-POP', 'เซนต์รัล', 'เมียงดง', 'จิจูไอส์แลนด์'],
              ...
              { 
                ...
                highlights: ['โรม', 'ปิซา', 'เวนิส', 'โคลอสเซียม'],
              ...
              >
                ...
                <div className="p-4 bg-white">
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {country.highlights.slice(0, 3).map((highlight, hIdx) => (
                      <span key={hIdx} className="bg-blue-50 text-blue-700 text-xs px-2 py-1 rounded-full border border-blue-200">
                        {highlight}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-xl md:text-2xl font-bold text-gray-800">{country.price}</span>
                        <span className="text-sm text-gray-500 line-through">{country.originalPrice}</span>
                      </div>
                      <div className="text-xs text-gray-600 mt-1">ราคาต่อคน</div>
                    </div>
                    <div className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm font-medium hover:shadow-lg transition-all">
                      ดูทัวร์
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-8">
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <span className="flex items-center gap-2">
                <span>ดูทุกจุดหมาย</span>
                <span>🌎</span>
              </span>
            </button>
          </div>
        ...
        {/* Popular Tours Section - Mobile First Horizontal Scroll Design */}
        <div className="mb-6 md:mb-8">
          {/* Header Section */}
          <div className="px-3 md:px-6 mb-6">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-3">
                ...
                <span className="bg-white/20 px-2 py-0.5 rounded-full text-xs">HOT</span>
              </div>
              <h3 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">แพ็คเกจทัวร์พิเศษ</h3>
              <p className="text-gray-600 text-sm md:text-base">คัดสรรแล้วจากนักเดินทางหลายพันคน</p>
            </div>
          </div>
          
          {/* Mobile First: Horizontal Scroll, Desktop: Grid */}
              ...
              {[
                {
                  ...
                  includes: ['เที่ยวบิน', 'โรงแรม 4*', 'มื้ออาหาร', 'รถทัวร์'],
                  highlight: 'ซากุระบานเต็มที่'
                },
                {
                  title: 'เกาหลี K-POP',
                  ...
                  includes: ['เที่ยวบิน', 'โรงแรม 3*', 'มื้ออาหาร', 'รถทัวร์'],
                  highlight: 'คอนเสิร์ต K-POP'
                },
                {
                  title: 'ไต้หวัน Street Food',
                  subtitle: 'Taipei • Taichung • Kaohsiung',
                  ...
                  includes: ['เที่ยวบิน', 'โรงแรม 3*', 'ไกด์', 'รถทัวร์'],
                  highlight: 'ตลาดกลางคืนขึ้นชื่อ'
                },
                {
                  title: 'ยุโรป 4 ประเทศ',
                  subtitle: 'Italy • Swiss • France • Germany',
                  ...
                  includes: ['เที่ยวบิน', 'โรงแรม 4*', 'มื้ออาหาร', 'รถทัวร์'],
                  highlight: 'ปราสาทโบราณ 4 ประเทศ'
                },
                {
                  title: 'โตเกียว ดิสนีย์แลนด์',
                  subtitle: 'Tokyo Disneyland • DisneySea',
                  ...
                  bgImage: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop&auto=format&q=80',
                  includes: ['เที่ยวบิน', 'โรงแรม 4*', 'ตั้วดิสนีย์', 'รถทัวร์'],
                  highlight: 'ครอบครัวและเด็ก'
                },
                {
                  title: 'สิงคโปร์ มาเลเซีย',
                  subtitle: 'Singapore • Kuala Lumpur',
                  description: 'ไดเวอร์สิตี้ แหล่งช้อปปิ้ง อาหารนานาชาติ',
                  duration: '4 วัน 3 คืน',
                  price: '฿18,900',
                  ...
                  categoryIcon: '🛍️',
                  search: 'สิงคโปร์',
                  bgImage: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=800&h=600&fit=crop&auto=format&q=80',
                  includes: ['เที่ยวบิน', 'โรงแรม 4*', 'มื้ออาหาร', 'รถทัวร์'],
                  highlight: 'ช้อปปิ้งสุดคุ้ม'
                }
              ].map((tour, idx) => (
                <button
                  key={idx}
                  onClick={() => setSearchTerm(tour.search)}
                  className="group flex-shrink-0 w-80 md:w-auto bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden snap-center md:snap-align-none"
                >
                  {/* Image Section */}
                  <div className="relative h-44 md:h-48 overflow-hidden">
                    ...
                    <div className="absolute bottom-3 left-3 right-3">
                      <h4 className="text-white text-lg font-bold mb-1 drop-shadow-lg">{tour.title}</h4>
                      <p className="text-white/90 text-xs mb-2 drop-shadow">{tour.subtitle}</p>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {tour.includes.slice(0, 3).map((include, iIdx) => (
                        <span key={iIdx} className="bg-green-50 text-green-700 text-xs px-2 py-1 rounded-full border border-green-200">
                          {include}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:shadow-lg transition-all duration-300 hover:scale-105">
                        จองเลย
                      </div>
                    </div>
                  </div>
          ...
          {/* View All Button */}
          <div className="text-center mt-8 px-3 md:px-6">
            <button 
              onClick={() => setSearchTerm('')}
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          <div className="flex-1 p-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
              ...
              <div className="space-y-2 w-full sm:w-auto">
                <Link
                  href={`/tour-search-28/${tour.id}?src=search28`}
