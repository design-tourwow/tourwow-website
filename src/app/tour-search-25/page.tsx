...
export default function TourSearch16() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Popular Countries */}
      <div className="px-4 py-4">
        {/* Popular Destinations - Cyberpunk Neon */}
        <div className="mb-8">
          <div className="mb-8 text-center relative">
            <div className="relative inline-block">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 rounded-2xl blur-md opacity-75"></div>
              <div className="relative bg-black border border-cyan-400 rounded-2xl px-8 py-4">
                <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 text-2xl md:text-3xl font-black uppercase tracking-widest">
                  ⚡ NEURAL LINKS
                </h2>
            ...
            <p className="text-gray-400 mt-4 font-mono text-sm tracking-wider">// Access global destinations matrix</p>
          </div>
          
          {/* Cyberpunk Neural Grid */}
            ...
            {[
              {
                ...
                status: 'ONLINE',
                signal: 98,
                neonColor: 'from-cyan-400 to-blue-600',
              ...
              },
              {
                ...
                status: 'ACTIVE',
                signal: 94,
                neonColor: 'from-purple-400 to-pink-600',
              ...
              },
              {
                ...
                status: 'SYNC',
                signal: 99,
                neonColor: 'from-emerald-400 to-cyan-600',
              ...
              },
              {
                ...
                status: 'LIVE',
                signal: 91,
                neonColor: 'from-yellow-400 to-orange-600',
              ...
              },
              {
                ...
                status: 'CONN',
                signal: 87,
                neonColor: 'from-pink-400 to-rose-600',
              ...
              },
              {
                ...
                status: 'LINK',
                signal: 85,
                neonColor: 'from-orange-400 to-red-600',
              ...
              },
              {
                ...
                status: 'MESH',
                signal: 83,
                neonColor: 'from-red-400 to-pink-600',
              ...
              },
              {
                ...
                status: 'FLOW',
                signal: 79,
                neonColor: 'from-green-400 to-emerald-600',
              ...
              <button
                ...
                className={`group relative bg-black/90 backdrop-blur-sm border border-gray-800 rounded-xl p-4 transition-all duration-300 hover:border-cyan-400 hover:shadow-xl ${dest.glowColor} hover:scale-105`}
              >
                {/* Neural Header */}
                <div className="flex justify-between items-center mb-3">
                  <div className="text-gray-400 font-mono text-xs tracking-wider">{dest.code}</div>
                  <div className={`px-2 py-1 rounded-full text-xs font-mono bg-gradient-to-r ${dest.neonColor} text-black font-bold animate-pulse`}>
                    {dest.status}
                  </div>
                </div>
                ...
                <div className="text-center mb-4">
                  <h3 className={`text-transparent bg-clip-text bg-gradient-to-r ${dest.neonColor} text-lg font-black tracking-wide mb-2`}>
                    {dest.name}
                  </h3>
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-xs font-mono">
                    ...
                    <span className="text-cyan-400">{dest.signal}%</span>
                  </div>
                  <div className="w-full bg-gray-800 rounded-full h-1">
                    <div 
                      className={`h-1 rounded-full bg-gradient-to-r ${dest.neonColor} animate-pulse`}
                      style={{width: `${dest.signal}%`}}
                    ></div>
                  </div>
                  <div className="flex justify-between text-xs font-mono">
                    <span className="text-gray-400">TOURS:</span>
                    <span className="text-purple-400">{dest.tours}</span>
                  </div>
                  <div className="flex justify-between text-xs font-mono">
                    <span className="text-gray-400">RATE:</span>
                    <span className="text-pink-400">฿{dest.price}</span>
                  </div>
                </div>
                
                {/* Connect Button */}
                <div className="relative">
                  <div className={`absolute inset-0 bg-gradient-to-r ${dest.neonColor} rounded-lg blur opacity-30 group-hover:opacity-50 transition-opacity`}></div>
                  <div className="relative bg-black border border-gray-700 rounded-lg py-2 px-4 text-center">
                    <span className="text-gray-300 font-mono text-xs tracking-widest group-hover:text-white transition-colors">
                      CONNECT
                    </span>
                  </div>
                </div>
        ...
        {/* Popular Tours - Data Streams */}
        <div className="mb-8">
          <div className="mb-8 text-center relative">
            <div className="relative inline-block">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 rounded-2xl blur-lg opacity-60"></div>
              <div className="relative bg-gradient-to-r from-gray-900 to-black border border-purple-400 rounded-2xl px-8 py-4">
                <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-cyan-400 to-pink-400 text-2xl md:text-3xl font-black uppercase tracking-widest">
                  🌐 DATA STREAMS
                </h2>
                <div className="flex justify-center space-x-2 mt-2">
                  <div className="text-cyan-400 font-mono text-xs animate-pulse">«</div>
                  <div className="text-purple-400 font-mono text-xs animate-pulse delay-100">«</div>
                  <div className="text-pink-400 font-mono text-xs animate-pulse delay-200">«</div>
                </div>
              </div>
            </div>
            <p className="text-gray-400 mt-4 font-mono text-sm tracking-wider">// Premium experience packages loading...</p>
          </div>
            ...
            {[
              {
                ...
                protocol: 'HTTPS/3.0',
                status: 'STREAMING',
                neonGlow: 'shadow-cyan-500/50',
                borderGrad: 'from-cyan-400 to-blue-500'
              },
              {
                name: 'SEOUL MATRIX',
                code: 'SEL.PKG.002',
                ...
                protocol: 'WSS/2.1',
                status: 'ACTIVE',
                neonGlow: 'shadow-purple-500/50',
                borderGrad: 'from-purple-400 to-pink-500'
              },
              {
                name: 'SINGAPORE GRID',
                code: 'SGP.SYS.003',
                ...
                protocol: 'TCP/4.0',
                status: 'ONLINE',
                neonGlow: 'shadow-emerald-500/50',
                borderGrad: 'from-emerald-400 to-cyan-500'
              }
            ].map((stream, idx) => (
              <div key={idx} className={`group relative bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl border border-gray-700 rounded-2xl overflow-hidden transition-all duration-500 hover:border-cyan-400 hover:shadow-2xl ${stream.neonGlow} hover:scale-[1.02]`}>
                {/* Data Header */}
                <div className="relative">
                  <div className={`absolute inset-0 bg-gradient-to-r ${stream.borderGrad} opacity-20`}></div>
                  <div className="relative p-4 border-b border-gray-800">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <div className="text-gray-400 font-mono text-xs tracking-wider">{stream.code}</div>
                        <h3 className={`text-transparent bg-clip-text bg-gradient-to-r ${stream.borderGrad} text-lg font-black tracking-wide`}>
                          {stream.name}
                        </h3>
                      </div>
                      <div className={`px-3 py-1 bg-gradient-to-r ${stream.borderGrad} text-black font-mono text-xs font-bold rounded-full animate-pulse`}>
                        {stream.status}
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 text-xs font-mono">
                      ...
                      <span className="text-purple-400">{stream.protocol}</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      <div className="flex justify-between text-xs font-mono mb-1">
                        ...
                        <span className="text-cyan-400">{stream.bandwidth}%</span>
                      </div>
                      <div className="w-full bg-gray-800 rounded-full h-1.5">
                        <div 
                          className={`h-1.5 rounded-full bg-gradient-to-r ${stream.borderGrad} animate-pulse`}
                          style={{width: `${stream.bandwidth}%`}}
                        ></div>
                      </div>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-black/50 border border-gray-700 rounded-lg p-2 text-center">
                        <div className="text-gray-400 text-xs font-mono">SECURITY</div>
                        <div className="text-cyan-400 text-xs font-bold mt-1">{stream.security}</div>
                      </div>
                      <div className="bg-black/50 border border-gray-700 rounded-lg p-2 text-center">
                        <div className="text-gray-400 text-xs font-mono">RATE</div>
                        <div className="text-pink-400 text-xs font-bold mt-1">฿{stream.price.toLocaleString()}</div>
                      </div>
                    </div>
                  </div>
                  
                  {/* Download/Connect Button */}
                  <div className="relative">
                    <div className={`absolute inset-0 bg-gradient-to-r ${stream.borderGrad} rounded-xl blur opacity-20 group-hover:opacity-40 transition-opacity`}></div>
                    <button className="relative w-full bg-black border border-gray-600 rounded-xl py-3 px-4 transition-all duration-300 group-hover:border-cyan-400">
                      <div className="flex items-center justify-center space-x-2">
                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                        <span className="text-gray-300 font-mono text-sm tracking-widest group-hover:text-white">
                          DOWNLOAD
                        </span>
                        <div className="text-cyan-400 font-mono text-sm animate-pulse">&gt;&gt;</div>
                      </div>
                    </button>
                  </div>
                </div>
