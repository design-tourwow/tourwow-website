          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <button
                ...
                className={`group bg-white rounded-2xl ${dest.borderColor} border-2 overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105`}
              >
                ...
                <div className="p-4">
                  ...
                  <div className={`${dest.color} ${dest.textColor} px-3 py-2 rounded-lg text-center font-bold text-sm`}>
                    เริ่มต้น ฿{dest.price}
                  </div>
                </div>
              </button>
        ...
        <div className="mt-12">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                title: 'ไต้หวัน Street Food Tour',
                search: 'ไต้หวัน',
              ...
              <button
                ...
                className="w-full bg-white border border-gray-100 rounded-2xl p-4 hover:shadow-md hover:border-gray-200 transition-all duration-300 group"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      <span className={`${tour.categoryBg} ${tour.categoryText} px-2 py-1 rounded-lg text-xs font-medium flex items-center gap-1`}>
                        {tour.emoji} {tour.category}
                      </span>
                      <span className="text-gray-600 text-sm">{tour.duration}</span>
                      <div className="flex items-center gap-1">
                        <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                        <span className="text-gray-600 text-sm font-medium">{tour.rating}</span>
                      </div>
                    </div>
                  </div>
                </div>
