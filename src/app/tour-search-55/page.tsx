              ...
              <div className="group cursor-pointer">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      <div className="mb-2 flex flex-wrap gap-1">
                        <span className="inline-block bg-gray-600 bg-opacity-80 text-white px-2 py-1 rounded-md text-xs font-medium">
                          โตเกียว
                        </span>
                        <span className="inline-block bg-gray-600 bg-opacity-80 text-white px-2 py-1 rounded-md text-xs font-medium">
                          เกียวโต
                ...
                <div className="bg-white p-3 rounded-b-xl shadow-sm -mt-1">
                  ...
                  <div className="flex items-center gap-1 text-gray-600">
                    ...
                    <div className="flex flex-col items-end justify-start ml-4 mt-6">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>วัดทองคำสีทองค่าตอนรุ่ง, พิธีการชาไทย และเชิญชมคิมโนะยืนตอนกลางคืน สวมชุดไกตะสีสันติๆ และถ่ายรูปทิวทัศน์กับป่าไผ่บามบู</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">3,124</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿44,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.9} reviewCount={9234} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿32,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">1,895</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿37,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.7} reviewCount={4567} />
                        <div className="text-right space-y-1">
                          ...
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿29,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">1,234</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿34,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.6} reviewCount={3421} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿26,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute top-0 right-0 z-20">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white px-4 py-1.5 rounded-bl-xl shadow-md">
                      <p className="text-base font-semibold tracking-wide">
                        TW{(() => {
                          const hash = 'Tour Card'.split('').reduce((acc, char) => acc + char.charCodeAt(0), 0);
                          const code = String(10000 + (hash % 90000)).padStart(5, '0');
                          return code;
                        })()}
                      </p>
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">2,567</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿28,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.5} reviewCount={5789} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿22,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">4,321</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿59,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.8} reviewCount={7842} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿39,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>K-Culture สุดเจ๋งที่โลตเต้เวิลด์ ชมหนังคอนเสิร์ต K-POP และพบไอดอลคู่ใจ เดินช้อปปิ้งที่แกงนัม และลิ้มลองคิมชิ และบัลโกกี</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">3,156</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>ตลาดกลางคืนไรผลไผวริกช้อปตลอด 24 ชม. ขึ้นดีกดูตัวเมืองบนไทเป 101 เที่ยวชมบรรยากาศยามสวยเจิ้งเจัด และชิมขนมตาลทาไวย่</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">1,789</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>เมืองอนาคตแห่งอาเซียน ชมพิพิธภัณฑ์สวนน้ำ Gardens by the Bay เที่ยวสวนสัตว์ Universal Studios พร้อมลิ้มลองสิงคโปร์ และชื่นชมมัรลายอน</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">5,432</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>ทาวเวอร์แฝดปีโทรนาส 88 ชั้นสูงสุดตาตื่นไปดูวิวเมือง, เที่ยวถ้ำบาตู และคาร์นิวอลกวางพีนัง ลิ้มลองอาหารหลายวัฒนธรรมสุดอร่อย</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">2,891</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>เกาะบาหลีที่รอคอยด้วยคืนคลื่นสีฟ้าใส เที่ยววัดโบโรพุทโธที่โบราณที่สุด เที่ยวจอกใสเทลากาลูก และสปาทอง พร้อมชมนาซีกอริงไนอล</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">3,678</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>เกาะโบราคาย์หาดทรายทรงสวยที่สุดในโลก ดำน้ำใสอ่าวปะการัง สนุกกับอาหารทะเลอร่อยตาแบบฟิลิปปินส์ และผ่อนคลายบนคลื่นสาว</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">2,654</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>เรือโดยสารบนฮาลองเบย์ ชมหินทรายรูปทรงสีเขียวอมไอน้ำ เที่ยวโฮจิมินห์ไซตั๋วโลก ลิ้มลองกาแฟอิกและเบียร์เวียดนาม เยี่ยมเก่าบ้านเรือนบนแม่น้ำโขง</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">4,123</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>นครวัดอังกอร์โบราณที่เก่าแก่ที่สุดในโลก เที่ยวเสียมเรียบสุดมหัศจรรย์ ชมหินปราสาทบายุนนาควัด และถ่ายรูปเซลฟี่กับความโบราณ</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">1,987</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿19,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.4} reviewCount={1234} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿15,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="text-white pt-2 pb-10 px-4 bg-gradient-to-t from-black/60 via-black/30 to-transparent [text-shadow:_1px_1px_2px_rgba(0,0,0,0.5)]">
                      ...
                      <div className="text-base font-semibold text-white"><QuotedText><span>เมืองมรดกแห่งหลวงพระบาง ไปนั่งโป้งริมแม่น้ำโขง เที่ยววัดทองคำที่ประกายอย่างเนิบนิยม เคื้อนโลหีตขั้นธรรมดา และเพลิดเพลินกับบรรยากาศเงียบสงบ</span></QuotedText></div>
                      <div className="mt-4 mb-1 flex items-center justify-between">
                        <p className="text-sm text-white font-medium">
                          ทัวร์นี้ถูกจองแล้วกว่า <span className="font-bold text-yellow-300">1,432</span> <span className="font-bold text-white">ที่</span>
                        </p>
                        <div className="flex items-center gap-2">
                          <div className="text-sm text-white font-medium">เริ่มต้น</div>
                          <div className="relative inline-block">
                            <span className="text-base text-white font-medium">฿17,900</span>
                            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-red-400 transform -translate-y-1/2 rotate-[-12deg]"></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <StarRating rating={4.3} reviewCount={1567} />
                        <div className="text-right space-y-1">
                          <div className="text-2xl font-bold text-yellow-400 leading-tight">฿13,900</div>
                        </div>
                      </div>
                    </div>
                  </div>
