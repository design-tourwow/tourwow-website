      ...
      {((tour.gallery && tour.gallery.length > 0) || tour.video) && (
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-100 py-3">
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            <div className="flex justify-start lg:justify-center space-x-4 overflow-x-auto scrollbar-hide">
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-8 p-4 lg:p-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div id="highlights-section" className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-5 border border-blue-200 order-1">
            ...
            <div id="price-breakdown-section" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div id="included-excluded-section" className="grid md:grid-cols-2 gap-4">
            ...
            <div id="reviews-section" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center space-x-2">
            ...
            <div id="terms-section" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center space-x-2">
