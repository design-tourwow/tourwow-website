                ...
                <div className="relative aspect-[5/6] overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300 bg-white border border-gray-200">
                  ...
                  <div className="relative h-[45%] overflow-hidden">
                    ...
                    <div className="carousel-container relative w-full h-full">
                      ...
                      />
                      <img
                        src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop&auto=format&q=100"
                        alt="Japan 2"
                        className="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-500 opacity-0"
                      />
                      <img
                        src="https://images.unsplash.com/photo-1549378725-b93c3e3b9e6d?w=800&h=600&fit=crop&auto=format&q=100"
                        alt="Japan 3"
                        className="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-500 opacity-0"
                      />
                      <img
                        src="https://images.unsplash.com/photo-1480796927426-f609979314bd?w=800&h=600&fit=crop&auto=format&q=100"
                        alt="Japan 4"
                        className="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-500 opacity-0"
                      />
                    </div>
