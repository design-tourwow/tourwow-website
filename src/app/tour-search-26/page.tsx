...
export default function TourSearch16() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Popular Countries */}
      <div className="px-4 py-4">
        {/* Popular Destinations - Retro Gaming */}
        <div className="mb-8">
          <div className="mb-8 text-center">
            <div className="bg-black border-4 border-lime-400 shadow-[8px_8px_0px_0px_#ff00ff] p-2 inline-block">
              <div className="bg-gradient-to-r from-lime-400 via-cyan-400 to-violet-400 px-6 py-3">
                <h2 className="text-black text-2xl md:text-3xl font-black uppercase tracking-tight">
                  🎮 SELECT STAGE
                </h2>
              </div>
            </div>
            <p className="text-gray-600 mt-3 font-mono">█ Choose your adventure level █</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <button
                ...
                className={`group bg-black border-4 ${dest.borderColor} shadow-[6px_6px_0px_0px_#ff00ff] p-3 rounded-lg transition-all duration-200 hover:shadow-[8px_8px_0px_0px_#ff00ff] hover:-translate-x-1 hover:-translate-y-1 active:shadow-[2px_2px_0px_0px_#ff00ff] active:translate-x-1 active:translate-y-1`}
              >
                {/* Arcade Screen Header */}
                <div className="bg-black text-lime-400 p-2 font-mono text-xs flex justify-between items-center mb-3">
                  <span className="animate-pulse">█ {dest.level} █</span>
                  <span className="animate-pulse text-red-400">● REC</span>
                </div>
                
                {/* Character Display */}
                <div className={`${dest.bgColor} text-black p-4 rounded border-2 border-gray-700 mb-3`}>
                  <div className="text-4xl text-center mb-2">{dest.emoji}</div>
                  <div className="text-center font-black text-xs uppercase tracking-wider">
                    {dest.name}
                  </div>
                </div>
                
                {/* Gaming Stats */}
                <div className="bg-gray-900 text-green-400 font-mono text-xs p-2 rounded border border-green-400 mb-2">
        ...
        {/* Popular Tours - Boss Battles */}
        <div className="mb-8">
          <div className="mb-8 text-center">
            <div className="bg-black border-4 border-red-500 shadow-[8px_8px_0px_0px_#00ff00] p-2 inline-block">
              <div className="bg-gradient-to-r from-red-500 via-yellow-400 to-orange-500 px-6 py-3">
                <h2 className="text-black text-2xl md:text-3xl font-black uppercase tracking-tight">
                  🚀 BOSS BATTLES
                </h2>
              </div>
            </div>
            <p className="text-gray-600 mt-3 font-mono">█ Challenge the ultimate adventures █</p>
          </div>
            ...
            {[
              {
                ...
                duration: '5D/4N',
                price: 45900,
                bgGrad: 'from-pink-500 to-purple-600',
              ...
              },
              {
                ...
                duration: '4D/3N',
                price: 32500,
                bgGrad: 'from-purple-500 to-blue-600',
                borderColor: 'border-purple-400'
              },
              {
                boss: 'MERLION GUARDIAN',
                level: 'BOSS LV.6',
                hp: 1200,
                maxHp: 1200,
                element: 'WATER',
                ...
                duration: '4D/3N',
                price: 28900,
                bgGrad: 'from-cyan-500 to-teal-600',
                borderColor: 'border-cyan-400'
              }
            ].map((boss, idx) => (
              <div key={idx} className={`group bg-black border-4 ${boss.borderColor} shadow-[6px_6px_0px_0px_#00ff00] rounded-lg overflow-hidden hover:shadow-[8px_8px_0px_0px_#00ff00] hover:-translate-x-1 hover:-translate-y-1 transition-all duration-200`}>
                {/* Boss Header */}
                <div className={`bg-gradient-to-r ${boss.bgGrad} p-4 relative`}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="bg-black text-white px-2 py-1 text-xs font-mono rounded">
                      {boss.level}
                    </span>
                    <span className="bg-black text-lime-400 px-2 py-1 text-xs font-mono rounded animate-pulse">
                      {boss.element}
                    </span>
                  </div>
                ...
                <div className="bg-gray-900 p-3">
                  ...
                  <div className="bg-black border border-green-400 h-3 rounded">
                    <div className="bg-gradient-to-r from-green-400 to-lime-400 h-full rounded animate-pulse" style={{width: '100%'}}></div>
                  </div>
                </div>
                ...
                <div className="bg-gray-900 p-4">
                  <div className="grid grid-cols-2 gap-2 text-center mb-4">
                    <div className="bg-black border border-yellow-400 p-2 rounded">
                      <div className="text-yellow-400 text-xs font-mono">ATK</div>
                      <div className="text-white font-black">★★★★☆</div>
                    </div>
                    <div className="bg-black border border-cyan-400 p-2 rounded">
                      <div className="text-cyan-400 text-xs font-mono">DEF</div>
                      <div className="text-white font-black">★★★☆☆</div>
                    </div>
                  </div>
                  
                  {/* Price & Challenge Button */}
                  <div className="bg-black border-2 border-red-500 p-3 rounded">
                    <div className="text-red-400 text-center font-mono text-xs mb-2">CHALLENGE COST</div>
                    <div className="text-center">
                      <div className="text-yellow-400 font-black text-xl">฿{boss.price.toLocaleString()}</div>
                      <button className="bg-red-600 hover:bg-red-700 text-white font-black text-xs px-4 py-2 mt-2 rounded border-2 border-red-400 uppercase tracking-wider transition-all hover:animate-pulse">
                        {'>> CHALLENGE <<'}
                      </button>
                    </div>
                  </div>
