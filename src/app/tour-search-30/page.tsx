...
export default function TourSearch27() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Popular Countries - Mobile First Masonry Layout */}
      <div className="px-3 py-4 md:px-6 md:py-6">
        <div className="mb-6 md:mb-8">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-3">
              <span>✈️</span>
              <span>เที่ยวทั่วโลก</span>
            </div>
            <h2 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">จุดหมายในฝันของคุณ</h2>
            <p className="text-gray-600 text-sm md:text-base">ค้นพบประสบการณ์ท่องเที่ยวสุดพิเศษไปกับเรา</p>
          </div>
          
          {/* Mobile First: Masonry Style Layout */}
          <div className="columns-1 md:columns-2 lg:columns-3 gap-4 md:gap-6 space-y-4 md:space-y-6">
            {[
              { 
                ...
                longDescription: 'ดื่มด่ำกับความงามของดอกซากุระที่บานสะพรั่ง สัมผัสวัฒนธรรมดั้งเดิมผ่านวัดเก่าแก่ และสำรวจความทันสมัยของโตเกียว',
                highlights: ['ซากุระ', 'รามเทพ', 'โตเกียว', 'เกียวโต', 'ฟูจิซัง'],
              ...
              { 
                ...
                longDescription: 'สัมผัสวัฒนธรรม K-POP ที่แท้จริง ช้อปปิ้งที่เมียงดง และอิ่มอร่อยกับอาหารเกาหลีแท้',
                highlights: ['K-POP', 'เมียงดง', 'จิจูไอส์แลนด์', 'ปูซาน'],
              ...
              { 
                ...
                longDescription: 'ลิ้มรสอาหารข้างถนนขึ้นชื่อ เดินเที่ยวตลาดกลางคืนสุดคึกคัก และชมธรรมชาติอันงดงาม',
                highlights: ['ไทเป 101', 'ตลาดกลางคืน', 'อาลีซาน', 'ทะเลสาบสุริยัน'],
              ...
              { 
                ...
                longDescription: 'เดินทางย้อนเวลาผ่านสถาปัตยกรรมโรมัน ชิมอาหารอิตาเลียนแท้ และชื่นชมงานศิลปะระดับโลก',
                highlights: ['โรม', 'ปิซา', 'เวนิส', 'โคลอสเซียม', 'วาติกัน'],
              ...
              { 
                ...
                longDescription: 'สูดอากาศบริสุทธิ์บนเทือกเขาแอลป์ ชิมช็อคโกแลตแท้ และสัมผัสธรรมชาติอันงดงาม',
                highlights: ['เจนีวา', 'ภูเขาแอลป์', 'ช็อคโกแลต', 'จุงเฟรา'],
              ...
              { 
                ...
                longDescription: 'ชมแสงออรอร่าสุดมหัศจรรย์ เดินบนธารน้ำแข็งโบราณ และสัมผัสธรรมชาติอันน่าทึ่ง',
                highlights: ['ออรอร่า', 'ธารน้ำแข็ง', 'บลูลากูน', 'เกย์เซอร์'],
              ...
              <button
                ...
                className={`group block w-full overflow-hidden rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white break-inside-avoid mb-4 md:mb-6`}
              >
                {/* Main Image Container */}
                <div className={`relative ${country.height} overflow-hidden`}>
                  <div 
                  ...
                  <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="bg-white/90 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1">
                        ...
                        <span className="text-sm font-bold text-gray-800">{country.rating}</span>
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="text-white/90 text-sm mb-3 drop-shadow leading-relaxed">{country.longDescription}</p>
                    <div className="text-white/80 text-xs drop-shadow flex items-center gap-3">
                      <span>📅 {country.season}</span>
                      <span>•</span>
                      <span>🎯 {country.tours}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-white">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {country.highlights.slice(0, 4).map((highlight, hIdx) => (
                      <span key={hIdx} className="bg-blue-50 text-blue-700 text-xs px-2.5 py-1 rounded-full border border-blue-200 font-medium">
                        {highlight}
                      </span>
                    ))}
                    {country.highlights.length > 4 && (
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-baseline gap-2 mb-1">
                        <span className="text-2xl font-bold text-gray-800">{country.price}</span>
                        <span className="text-base text-gray-500 line-through">{country.originalPrice}</span>
                      </div>
                      <div className="text-xs text-gray-600">ราคาต่อคน • รวมทุกอย่าง</div>
                    </div>
                    <div className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:shadow-lg transition-all duration-300 hover:scale-105">
                      เลือกเลย
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-10">
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
            >
              <span className="flex items-center gap-3">
                <span>สำรวจทุกจุดหมาย</span>
                <span>🗺️</span>
              </span>
            </button>
          </div>
        ...
        {/* Popular Tours Section - Mobile First Vertical Stack Design */}
        <div className="mb-6 md:mb-8">
          {/* Header Section */}
          <div className="px-3 md:px-6 mb-6">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-3">
                <span>⭐</span>
                <span>แพ็คเกจพิเศษ</span>
                <span className="bg-white/20 px-2 py-0.5 rounded-full text-xs">BEST</span>
              </div>
              <h3 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">ทัวร์สุดฮิตจากลูกค้า</h3>
              <p className="text-gray-600 text-sm md:text-base">แพ็คเกจที่นักเดินทางให้คะแนนสูงสุด</p>
            </div>
          </div>
          ...
          <div className="px-3 md:px-6">
            <div className="space-y-4 md:space-y-6">
              {[
                {
                  title: 'ญี่ปุ่น ซากุระบาน',
                  subtitle: 'ชมความงามของดอกไม้ชมพู และวัฒนธรรมดั้งเดิม',
                  duration: '5 วัน 4 คืน',
                  price: '฿25,900',
                  originalPrice: '฿32,900',
                  discount: 22,
                  ...
                  bgImage: 'https://images.unsplash.com/photo-1522383225653-ed111181a951?w=800&h=600&fit=crop&auto=format&q=80',
                  places: ['โตเกียว', 'เกียวโต', 'โอซากา', 'ภูเขาฟูจิ'],
                  includes: ['เที่ยวบินตรง', 'โรงแรม 4 ดาว', 'มื้ออาหารครบ', 'ไกด์ท้องถิ่น'],
                  highlight: 'ซากุระบานเต็มที่ มีนาคม - พฤษภาคม'
                },
                {
                  title: 'เกาหลีใต้ K-POP พรีเมียม',
                  subtitle: 'สัมผัสวัฒนธรรมฮัลลยู ช้อปปิ้งและอาหารอร่อย',
                  duration: '4 วัน 3 คืน',
                  price: '฿15,900',
                  originalPrice: '฿19,900',
                  discount: 20,
                  ...
                  categoryIcon: '🎵',
                  search: 'เกาหลี',
                  bgImage: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&h=600&fit=crop&auto=format&q=80',
                  places: ['โซล', 'ปูซาน', 'เจจู', 'เมียงดง'],
                  includes: ['เที่ยวบินตรง', 'โรงแรม 3-4 ดาว', 'คอนเสิร์ต K-POP', 'ไกด์ท้องถิ่น'],
                  highlight: 'รวมบัตรคอนเสิร์ตและฟานมีตติ้ง'
                },
                {
                  title: 'ยุโรป 5 ประเทศ คลาสสิก',
                  subtitle: 'เยือนปราสาทโบราณ กินอาหารเลิศ ชมศิลปะระดับโลก',
                  duration: '9 วัน 7 คืน',
                  price: '฿45,900',
                  ...
                  categoryIcon: '🏰',
                  search: 'ยุโรป',
                  bgImage: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=800&h=600&fit=crop&auto=format&q=80',
                  places: ['อิตาลี', 'สวิส', 'ฝรั่งเศส', 'เยอรมนี', 'ออสเตรีย'],
                  includes: ['เที่ยวบินตรง', 'โรงแรม 4-5 ดาว', 'มื้ออาหารครบ', 'ไกด์ท้องถิ่น'],
                  highlight: 'เยือนปราสาทโบราณมากกว่า 20 แห่ง'
                },
                {
                  title: 'ไต้หวัน อาหารและวัฒนธรรม',
                  subtitle: 'ลิ้มรสอาหารแท้ เที่ยววัดเก่า ชมวิวธรรมชาติ',
                  ...
                  categoryIcon: '🍜',
                  search: 'ไต้หวัน',
                  bgImage: 'https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=800&h=600&fit=crop&auto=format&q=80',
                  places: ['ไทเป', 'ไทจุง', 'กาอซุง', 'หัวเนียน'],
                  includes: ['เที่ยวบินตรง', 'โรงแรม 3 ดาว', 'ทัวร์อาหาร', 'ไกด์ท้องถิ่น'],
                  highlight: 'เที่ยวตลาดกลางคืนขึ้นชื่อ 5 แห่ง'
                }
              ].map((tour, idx) => (
                <button
                  key={idx}
                  onClick={() => setSearchTerm(tour.search)}
                  className="group w-full bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 overflow-hidden"
                >
                  <div className="flex flex-col md:flex-row">
                    {/* Image Section */}
                    <div className="relative w-full md:w-1/3 h-64 md:h-48 overflow-hidden">
                      <div 
                        className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                      ...
                      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="bg-white/95 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1">
                            <span className="text-yellow-500 text-sm">⭐</span>
                      ...
                      <div className="absolute bottom-4 left-4 right-4 md:hidden">
                        <h4 className="text-white text-xl font-bold mb-1 drop-shadow-lg">{tour.title}</h4>
                        <p className="text-white/90 text-sm drop-shadow">🕒 {tour.duration}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 p-6">
                      ...
                      <div className="hidden md:block mb-3">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">{tour.subtitle}</p>
                      </div>
                      ...
                      <div className="mb-4">
                        <div className="flex flex-wrap gap-2">
                          {tour.places.slice(0, 4).map((place, pIdx) => (
                            <span key={pIdx} className="bg-blue-50 text-blue-700 text-xs px-2.5 py-1 rounded-full border border-blue-200 font-medium">
                              {place}
                            </span>
                          ))}
                      ...
                      <div className="mb-4">
                        <div className="grid grid-cols-2 gap-2">
                          {tour.includes.map((include, iIdx) => (
                      ...
                      <div className="mb-4 p-3 bg-blue-50 rounded-xl border border-blue-200">
                        <p className="text-blue-700 text-sm font-medium">✨ {tour.highlight}</p>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                        <div>
                          <div className="flex items-baseline gap-2 mb-1">
                            <span className="text-3xl font-bold text-gray-800">{tour.price}</span>
                            {tour.originalPrice && (
                              <span className="text-lg text-gray-500 line-through">{tour.originalPrice}</span>
                            )}
                          </div>
                          <div className="text-sm text-gray-600">ราคาต่อคน • {tour.duration}</div>
                        </div>
                        <div className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl text-sm font-bold hover:shadow-lg transition-all duration-300 hover:scale-105 self-start sm:self-end">
                          จองทัวร์
                        </div>
                      </div>
                    </div>
          ...
          {/* View All Button */}
          <div className="text-center mt-10 px-3 md:px-6">
            <button 
              onClick={() => setSearchTerm('')}
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
            >
