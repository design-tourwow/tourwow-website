  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 py-4">
        ...
        {/* Popular Tours Section - Card Based Design */}
        <div className="mt-4 bg-gradient-to-br from-blue-50 to-white p-4 rounded-xl border border-gray-100 shadow-sm">
          <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
            ...
            <span className="text-xs font-normal text-gray-500 ml-2">อัพเดทล่าสุด</span>
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <button 
              ...
              className="bg-white rounded-lg border border-gray-200 p-3 hover:shadow-lg hover:border-blue-300 transition-all cursor-pointer group text-left"
            >
              {/* Badge */}
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-red-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span className="animate-pulse">🔥</span>
                  <span className="font-semibold">ขายดี</span>
                </span>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100">
                <div className="text-lg font-bold text-blue-600 group-hover:text-blue-700">
                  ฿25,900
                </div>
            ...
            >
              {/* Badge */}
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-purple-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span>✨</span>
                  <span className="font-semibold">ใหม่</span>
                </span>
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-green-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span>💰</span>
                  <span className="font-semibold">คุ้มสุด</span>
                </span>
              </div>
            ...
            >
              {/* Badge */}
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-orange-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span>⏰</span>
                  <span className="font-semibold">ลด 30%</span>
                </span>
              </div>
              ...
              <div className="space-y-1 text-xs text-gray-600 mb-3">
                ...
                <div className="flex items-center gap-1">
                  <span>✈️</span>
                  <span>พ.ย. - ธ.ค. 68</span>
                </div>
                <div className="flex items-center gap-1">
                  <span>⭐</span>
                  <span>4.9 (456 รีวิว)</span>
                </div>
              </div>
            ...
            <button 
              ...
              className="bg-white rounded-lg border border-gray-200 p-3 hover:shadow-lg hover:border-blue-300 transition-all cursor-pointer group text-left md:block hidden"
            >
              {/* Badge */}
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span>🎡</span>
                  <span className="font-semibold">ครอบครัว</span>
                </span>
              </div>
            ...
            >
              {/* Badge */}
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">
                  <span>💎</span>
                  <span className="font-semibold">งบ 20K</span>
                </span>
              </div>
