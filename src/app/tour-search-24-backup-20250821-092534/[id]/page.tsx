  ...
  return (
    <>
      ...
      <div className="lg:hidden bg-white border-b sticky top-0 z-40 shadow-sm">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <a href="tel:+66123456789" className="bg-green-500 text-white p-2 rounded-lg">
      ...
      <section id="hero-section" className="relative">
        ...
        {/* Flash Sale Timer */}
        {tour.flashSale && (
          <div className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 text-white py-3 px-4">
            <div className="flex items-center justify-center space-x-3">
              <Timer className="w-5 h-5 animate-pulse" />
              <span className="font-bold">เหลือเวลา: {formatTime(flashSaleTimeLeft)}</span>
              <span className="text-sm opacity-90">ราคาพิเศษ!</span>
            </div>
          </div>
        )}
      </section>
            ...
            <div id="booking-sidebar" className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-24">
              ...
              <div className="bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3 mb-4">
                <div className="flex items-center justify-center space-x-2 text-sm">
                  ...
                  <span className="font-medium">มี {viewingUsers} คน กำลังดูอยู่</span>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                {tour.originalPrice && (
                  <div className="text-lg text-gray-400 line-through">฿{formatPrice(tour.originalPrice)}</div>
                )}
              ...
              {tour.availableSeats <= 10 && (
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4 text-center">
                  ...
                  <div className="text-red-500 text-sm mt-1">จองเลยวันนี้ เพื่อไม่พลาดโอกาส</div>
                </div>
              )}
              ...
              {/* Trust Badge */}
              <div className="mt-6 flex items-center justify-center space-x-2 text-xs text-gray-500 bg-gray-50 py-2 px-3 rounded-lg">
          ...
          <div className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg flex items-center space-x-2"
              >
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-green-600 text-white py-3 rounded-xl font-bold flex items-center justify-center space-x-2"
                  >
