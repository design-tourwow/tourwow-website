          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="hidden sm:inline-block text-sm text-gray-500 font-medium">
                {filteredTours.length} ผลลัพธ์
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="sm:hidden text-xs text-gray-500 font-medium bg-gray-50 px-2 py-1 rounded-md">
                {filteredTours.length}
              </span>
              <button
                aria-label="ดูรายการโปรด"
                className="relative p-2.5 bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-xl transition-all duration-200 min-h-[48px] min-w-[48px] flex items-center justify-center shadow-sm hover:shadow-md"
              >
