...
import { Search, MapPin, Star, Heart, Clock, Users, Filter, ArrowRight, Grid, List, Phone, Info, Mic, TrendingUp, History, ChevronDown, ChevronUp, X } from 'lucide-react'
        ...
        <div className="px-4 py-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`relative px-3 sm:px-4 border-2 rounded-xl font-medium transition-all h-[68px] flex items-center gap-2 sm:gap-3 ${
            ...
            >
              ...
              <span className="hidden sm:inline text-lg whitespace-nowrap">ตัวกรอง</span>
              {getActiveFiltersCount() > 0 && (
                <div className="absolute -top-2 -right-2 w-6 h-6 sm:w-7 sm:h-7 bg-blue-600 text-white text-xs sm:text-sm font-bold rounded-full flex items-center justify-center animate-pulse">
