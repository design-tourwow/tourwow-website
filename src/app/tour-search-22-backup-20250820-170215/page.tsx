  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 py-4">
        ...
        {/* Popular Tours Section - Story Hero Cards */}
        <div className="mt-6">
          <div className="flex items-center justify-between mb-4 px-1">
            ...
            <span className="text-xs text-gray-500 font-medium">อัพเดทล่าสุด</span>
          </div>
          
          <div className="space-y-4">
            {/* Story Hero Card 1 - Japan Sakura */}
            <div 
              onClick={() => setSearchTerm('ญี่ปุ่น ซากุระ')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1522383225653-ed111181a951?w=1200&h=600&fit=crop&auto=format"
                  alt="ญี่ปุ่น ซากุระ"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-black/50 via-black/30 to-black/20 group-hover:from-black/60 group-hover:via-black/40 group-hover:to-black/30 transition-all duration-500" />
              </div>
              
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  <div className="bg-pink-500/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                  ...
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿25,900</span>
                    </div>
                  </div>
                </div>
                
                <div>
                  <h4 className="text-white font-bold text-xl mb-3 drop-shadow-2xl">
                    🗾 ญี่ปุ่น ซากุระ
                  </h4>
                  <div className="flex items-center justify-between">
            ...
            {/* Story Hero Card 2 - Korea K-POP */}
            <div 
              onClick={() => setSearchTerm('เกาหลี')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1200&h=600&fit=crop&auto=format"
                  alt="เกาหลี K-POP"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
              ...
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  <div className="bg-purple-500/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                    <span className="text-white font-bold text-sm flex items-center gap-1">
                      🎵 K-POP
                    </span>
                  </div>
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿15,900</span>
                    </div>
                  </div>
                </div>
            ...
            {/* Story Hero Card 3 - Taiwan Street Food */}
            <div 
              onClick={() => setSearchTerm('ไต้หวัน')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=1200&h=600&fit=crop&auto=format"
                  alt="ไต้หวัน Street Food"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
                />
              ...
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿9,900</span>
                    </div>
                    <div className="text-white text-xs line-through mt-1 font-medium drop-shadow-md">
                      ฿12,900
                    </div>
                  </div>
                </div>
            ...
            {/* Story Hero Card 4 - Europe 4 Countries */}
            <div 
              onClick={() => setSearchTerm('ยุโรป')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=1200&h=600&fit=crop&auto=format"
                  alt="ยุโรป 4 ประเทศ"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
              ...
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  <div className="bg-blue-600/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                    <span className="text-white font-bold text-sm flex items-center gap-1">
                      🏰 ปราสาท
                    </span>
                  </div>
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿45,900</span>
                    </div>
                    <div className="text-white text-xs line-through mt-1 font-medium drop-shadow-md">
                      ฿65,900
                    </div>
            ...
            {/* Story Hero Card 5 - Tokyo Disney */}
            <div 
              onClick={() => setSearchTerm('โตเกียว ดิสนีย์')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50 md:block hidden"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&h=600&fit=crop&auto=format"
                  alt="โตเกียว ดิสนีย์แลนด์"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
                />
              ...
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿32,900</span>
                    </div>
                  </div>
                </div>
            ...
            {/* Story Hero Card 6 - Budget Japan */}
            <div 
              onClick={() => setSearchTerm('ญี่ปุ่น งบน้อย')}
              className="relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer h-50 md:block hidden"
            >
              <div className="absolute inset-0">
                <Image
                  src="https://images.unsplash.com/photo-1606918801925-e2c914c4b503?w=1200&h=600&fit=crop&auto=format"
                  alt="ญี่ปุ่น งบประหยัด"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-700"
                  sizes="100vw"
                />
              ...
              <div className="relative z-10 h-full p-6 flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  <div className="bg-green-600/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                    <span className="text-white font-bold text-sm flex items-center gap-1">
                      💎 งบ 20K
                    </span>
                  </div>
                  <div className="text-right">
                    <div className="bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
                      <span className="text-gray-900 font-bold text-lg">฿19,900</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex-1 p-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
              ...
              <div className="space-y-2 w-full sm:w-auto">
                <Link
                  href={`/tour-search-22/${tour.id}?src=search24`}
