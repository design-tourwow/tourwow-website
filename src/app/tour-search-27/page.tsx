...
export default function TourSearch27() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Popular Countries - Mobile First White Background Design */}
      <div className="px-3 py-3 md:px-4 md:py-4">
        <div className="mb-4 md:mb-6 bg-white border border-gray-200 p-4 md:p-6 rounded-xl md:rounded-2xl shadow-sm md:shadow-md relative overflow-hidden">
          
          <div className="relative">
            <h2 className="text-lg md:text-2xl font-bold mb-4 md:mb-6 text-center text-gray-800">🌍 ประเทศยอดนิยม</h2>
            
            {/* Mobile First List Style Layout */}
            <div className="space-y-3 md:space-y-4">
              {[
                { 
                  ...
                  trend: '+12%',
                  flagCode: 'jp',
                  popular: 'ซากุระ, รามเทพ, โตเกียว',
                  bgImage: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800&h=600&fit=crop&auto=format'
                },
                { 
                  name: 'เกาหลีใต้',
                  tours: '89 ทัวร์',
                  ...
                  trend: '+8%',
                  flagCode: 'kr',
                  popular: 'K-POP, เซนต์รัล, เมียงดง',
                  bgImage: 'https://images.unsplash.com/photo-1538485399081-7191377e8241?w=800&h=600&fit=crop&auto=format'
                },
                { 
                  name: 'ไต้หวัน',
                  tours: '67 ทัวร์',
                  ...
                  trend: '+15%',
                  flagCode: 'tw',
                  popular: 'ไทเป, ตารางค่าตั๋ว, อาหาร',
                  bgImage: 'https://images.unsplash.com/photo-1508248467877-aec1b08de376?w=800&h=600&fit=crop&auto=format'
                },
                { 
                  name: 'อิตาลี',
                  tours: '112 ทัวร์',
                  ...
                  trend: '+5%',
                  flagCode: 'it',
                  popular: 'โรม, ปิซา, เวนิส',
                  bgImage: 'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=800&h=600&fit=crop&auto=format'
                },
                { 
                  name: 'สวิส',
                  tours: '43 ทัวร์',
                  ...
                  trend: '+3%',
                  flagCode: 'ch',
                  popular: 'เจนีวา, ภูเขาแอลป์, ช็อคโกแลต',
                  bgImage: 'https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=800&h=600&fit=crop&auto=format'
                },
                { 
                  name: 'ไอซ์แลนด์',
                  tours: '28 ทัวร์',
                  ...
                  trend: '+18%',
                  flagCode: 'is',
                  popular: 'ออรอร่า, ธารน้ำแข็ง, บลูลากูน',
                  bgImage: 'https://images.unsplash.com/photo-1520769669658-f07657f5a307?w=800&h=600&fit=crop&auto=format'
                }
              ].map((country, idx) => (
                <button
                  key={idx}
                  onClick={() => setSearchTerm(country.name)}
                  className="w-full rounded-lg md:rounded-xl overflow-hidden transition-all duration-300 hover:scale-[1.01] md:hover:scale-[1.02] hover:shadow-lg md:hover:shadow-xl border border-blue-200/50 hover:border-blue-300 relative group"
                >
                  {/* Background Image */}
                  <div 
                  ...
                  {/* Overlay - Brighter */}
                  <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-black/20 to-black/10 group-hover:from-black/20 group-hover:via-black/10 group-hover:to-transparent transition-colors duration-300"></div>
                  ...
                  <div className="relative p-3 md:p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3 md:space-x-4">
                        ...
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-white/80 overflow-hidden shadow-lg flex-shrink-0 bg-white/20 backdrop-blur-sm">
                          <Image 
                        ...
                        {/* Country Info - Mobile responsive */}
                        <div className="text-left min-w-0 flex-1">
                          <h3 className="text-base md:text-lg font-bold text-white truncate drop-shadow-lg">{country.name}</h3>
                          <p className="text-white/90 text-xs md:text-sm drop-shadow">{country.tours} • ⭐ {country.rating}</p>
                          <p className="text-white/80 text-xs mt-1 truncate md:whitespace-normal drop-shadow">{country.popular}</p>
                        </div>
                      </div>
                      
                      <div className="text-right flex-shrink-0 ml-2">
                        <div className="bg-black/40 backdrop-blur-md rounded-lg px-3 py-2 border border-white/30 shadow-lg">
                          <div className="text-lg md:text-xl font-bold text-white drop-shadow-lg">{country.price}</div>
                          <div className="text-white/80 text-xs md:text-sm line-through font-medium drop-shadow">{country.originalPrice}</div>
                          <div className="text-green-300 text-xs md:text-sm font-bold drop-shadow">💥 ลด {Math.round(((parseInt(country.originalPrice.replace('฿', '').replace(',', '')) - parseInt(country.price.replace('฿', '').replace(',', ''))) / parseInt(country.originalPrice.replace('฿', '').replace(',', '')) * 100))}%</div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {/* Popular Tours Section - Mobile First White Background Design */}
        <div className="mt-4 md:mt-6 bg-white border border-gray-200 p-4 md:p-6 rounded-xl md:rounded-2xl shadow-sm md:shadow-md relative overflow-hidden">
          
          <div className="relative">
            <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-4 md:mb-6 text-center flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-3">
              <div className="flex items-center gap-2">
                <span className="text-2xl md:text-3xl">🚀</span>
                <span>ทัวร์ยอดนิยม</span>
              </div>
              <span className="text-xs md:text-sm font-normal text-white bg-red-500 px-2 py-1 md:px-3 md:py-1 rounded-full shadow-lg">HOT</span>
            </h3>
              ...
              {[
                {
                  ...
                  description: 'ชมความงามของดอกซากุระ เที่ยววัดเก่าแก่ โตเกียว เกียวโต',
                  duration: '5 วัน 4 คืน',
                  price: '฿25,900',
                  originalPrice: null,
                  rating: '4.8',
                  ...
                  bgImage: 'https://images.unsplash.com/photo-1522383225653-ed111181a951?w=800&h=600&fit=crop&auto=format'
                },
                {
                  title: '🇰🇷 เกาหลี K-POP',
                  description: 'สัมผัสวัฒนธรรมเกาหลี ช้อปปิ้งเมียงดง ชม K-POP Concert',
                  duration: '4 วัน 3 คืน',
                  price: '฿15,900',
                  originalPrice: null,
                  rating: '4.7',
                  ...
                  search: 'เกาหลี',
                  bgImage: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&h=600&fit=crop&auto=format'
                },
                {
                  title: '🇹🇼 ไต้หวัน Street Food',
                  description: 'ลิ้มรสอาหารข้างถนน ตลาดกลางคืน ไทเป 101',
                  ...
                  search: 'ไต้หวัน',
                  bgImage: 'https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=800&h=600&fit=crop&auto=format'
                },
                {
                  title: '🇪🇺 ยุโรป 4 ประเทศ',
                  description: 'เยือนปราสาทโบราณ อิตาลี สวิส ฝรั่งเศส เยอรมนี',
                  duration: '8 วัน 6 คืน',
                  price: '฿45,900',
                  ...
                  search: 'ยุโรป',
                  bgImage: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=800&h=600&fit=crop&auto=format'
                },
                {
                  title: '🇯🇵 โตเกียว ดิสนีย์แลนด์',
                  description: 'ครอบครัวสนุก ดิสนีย์แลนด์ ดิสนีย์ซี ช้อปปิ้งชิบุยะ',
                  ...
                  tag: 'ครอบครัว',
                  tagIcon: '🎡',
                  bgColor: 'from-pink-500 to-fuchsia-600',
                  search: 'โตเกียว ดิสนีย์',
                  bgImage: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop&auto=format'
                }
              ].map((tour, idx) => (
                <button
                  key={idx}
                  onClick={() => setSearchTerm(tour.search)}
                  className="w-full rounded-xl md:rounded-2xl overflow-hidden transition-all duration-300 hover:scale-[1.01] md:hover:scale-[1.02] hover:shadow-lg md:hover:shadow-2xl border border-orange-200/50 hover:border-orange-300 relative group"
                >
                  {/* Background Image */}
                  <div 
                    className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-700"
                    style={{ backgroundImage: `url(${tour.bgImage})` }}
                  ></div>
                  
                  {/* Overlay - Brighter */}
                  <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-black/20 to-black/15 group-hover:from-black/20 group-hover:via-black/10 group-hover:to-black/5 transition-colors duration-300"></div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex-1 text-left min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                          <span className={`inline-flex items-center gap-1.5 md:gap-2 bg-gradient-to-r ${tour.bgColor} text-white text-xs md:text-sm px-3 py-1.5 md:px-4 md:py-2 rounded-full font-bold shadow-lg group-hover:shadow-xl transition-shadow self-start`}>
                            <span>{tour.tagIcon}</span>
                            <span>{tour.tag}</span>
                          </span>
                          <div className="flex items-center gap-1 text-white/90 bg-black/20 backdrop-blur-sm rounded-full px-2 py-1">
                            <span className="text-yellow-300">⭐</span>
                            <span className="text-xs md:text-sm font-medium">{tour.rating}</span>
                            <span className="text-xs">({tour.reviews})</span>
                          </div>
                        </div>
                        
                        <h4 className="text-lg md:text-xl font-bold text-white mb-2 group-hover:text-white/95 transition-colors drop-shadow-lg">
                          {tour.title}
                        </h4>
                        <p className="text-white/90 text-xs md:text-sm mb-2 leading-relaxed drop-shadow">
                          <span className="block md:hidden">
                            {tour.description.length > 60 ? `${tour.description.substring(0, 60)}...` : tour.description}
                          </span>
                          <span className="hidden md:block">
                            {tour.description}
                          </span>
                        </p>
                        <p className="text-white/80 text-xs md:text-sm font-medium drop-shadow">
                          🕒 {tour.duration}
                        </p>
                      </div>
                      
                      <div className="text-left sm:text-right flex-shrink-0 sm:ml-4 pt-2 sm:pt-0 border-t border-white/20 sm:border-t-0">
                        <div className="bg-black/40 backdrop-blur-md rounded-lg px-3 py-2 border border-white/30 shadow-lg">
                          <div className="text-2xl md:text-3xl font-bold text-white group-hover:text-white/95 transition-colors drop-shadow-lg">
                            {tour.price}
                          </div>
                          {tour.originalPrice && (
                            <div className="text-white/80 text-base md:text-lg line-through font-medium drop-shadow">
                              {tour.originalPrice}
                            </div>
                          )}
                          <div className="text-green-300 text-xs md:text-sm font-bold mt-1 drop-shadow">
                            💰 ราคาดีที่สุด
                          </div>
                        </div>
                      </div>
            ...
            {/* Mobile First Clean View All Button */}
            <div className="text-center mt-4 md:mt-6">
              <button 
                onClick={() => setSearchTerm('')}
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 md:py-3 px-6 md:px-8 rounded-xl md:rounded-2xl border border-blue-500 hover:border-blue-600 transition-all duration-300 hover:scale-[1.02] md:hover:scale-105 shadow-lg hover:shadow-xl"
              >
                <span className="flex items-center justify-center gap-2">
                  <span className="text-sm md:text-base">ดูทัวร์ทั้งหมด</span>
