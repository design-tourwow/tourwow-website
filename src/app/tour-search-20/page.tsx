...
const FlashSaleTimer = () => {
        ...
        if (seconds > 0) {
          ...
          if (minutes > 0) {
            ...
            if (hours > 0) {
              ...
              // Reset to 24 hours when reaches 0
              hours = 23;
              minutes = 59;
              seconds = 59;
            }
  ...
  return (
    <div className="flash-sale-timer">
      ...
      <span>Flash Sale จบใน {formatTime(timeLeft.hours)}:{formatTime(timeLeft.minutes)}:{formatTime(timeLeft.seconds)}</span>
    </div>
  );
};
...
const mockTours = Array.from({ length: 48 }, (_, i) => ({
  id: `tour-${i + 1}`,
  title: [
    'ญี่ปุ่น โตเกียว โอซาก้า เกียวโต 6 วัน 5 คืน',
    'ฝรั่งเศส ปารีส โปรวองซ์ 8 วัน 7 คืน',
    'อิตาลี โรม ฟลอเรนซ์ เวนิส 7 วัน 6 คืน',
    'สวิตเซอร์แลนด์ จุงเฟรา อินเทอร์ลาเคน 5 วัน 4 คืน',
    'เกาหลีใต้ โซล พูซาน เชจู 5 วัน 4 คืน',
    'สิงคโปร์ มาเลเซีย 4 วัน 3 คืน',
    'ตุรกี อิสตันบูล คัปปาโดเกีย 9 วัน 8 คืน',
    'อียิปต์ ไคโร ลุกซอร์ 7 วัน 6 คืน',
    'ดูไบ อาบูดาบี 5 วัน 4 คืน',
    'ออสเตรเลีย ซิดนีย์ เมลเบิร์น 7 วัน 6 คืน'
  ][i % 10],
  location: ['ญี่ปุ่น', 'ฝรั่งเศส', 'อิตาลี', 'สวิตเซอร์แลนด์', 'เกาหลีใต้', 'สิงคโปร์-มาเลเซีย', 'ตุรกี', 'อียิปต์', 'ดูไบ', 'ออสเตรเลีย'][i % 10],
  rating: 4.5 + ((i * 0.3) % 0.5),
  reviews: 50 + ((i * 17) % 450),
  price: 25000 + ((i * 2000) % 75000),
  originalPrice: i % 3 === 0 ? 30000 + ((i * 2500) % 90000) : null,
  duration: ['3 วัน 2 คืน', '4 วัน 3 คืน', '5 วัน 4 คืน', '6 วัน 5 คืน', '7 วัน 6 คืน', '8 วัน 7 คืน', '9 วัน 8 คืน'][i % 7],
  departureMonths: 'ก.ย. - ธ.ค. 2025',
  airline: ['Thai Airways', 'Singapore Airlines', 'Emirates', 'Qatar Airways', 'ANA', 'EVA Air'][i % 6],
  highlights: [
    ['ภูเขาไฟฟูจิ', 'วัดทอง', 'ช้อปปิ้งชินจูกุ'],
    ['หอไอเฟล', 'พิพิธภัณฑ์ลูฟวร์', 'ล่องเรือแม่น้ำแซน'],
    ['โคลอสเซียม', 'หอเอนปิซา', 'ล่องเรือกอนโดลา'],
    ['ยอดเขาจุงเฟรา', 'ทะเลสาบเจนีวา', 'รถไฟสายโรแมนติก'],
    ['พระราชวังเคียงบก', 'หมู่บ้านบุกชอน', 'เกาะเชจู'],
    ['มารีน่าเบย์', 'ยูนิเวอร์แซล', 'คาเมรอนไฮแลนด์'],
    ['บอลลูนคัปปาโดเกีย', 'สุเหร่าสีน้ำเงิน', 'ตลาดแกรนด์บาซาร์'],
    ['พีระมิด', 'หุบผากษัตริย์', 'ล่องเรือไนล์'],
    ['บุรจญ์คาลิฟา', 'ซาฟารีทะเลทราย', 'ตลาดทอง'],
    ['โอเปร่าเฮาส์', 'เกรทแบริเออร์รีฟ', 'สวนสัตว์โคอาลา']
  ][i % 10],
  badge: i % 4 === 0 ? ['ลดราคา', 'ยอดนิยม', 'Eco Tour', 'ที่นั่งเหลือน้อย'][i % 4] : null,
  ...
  includesTax: i % 2 === 0,
  tourType: ['พักผ่อน', 'ผจญภัย', 'หรูหรา', 'ครอบครัว', 'ธรรมชาติ'][i % 5],
  hasVisa: i % 2 === 1,
  guideLanguage: ['ไทย', 'ไทย-อังกฤษ', 'อังกฤษ'][i % 3],
  isPrivate: i % 5 === 4
}));
...
export default function TourSearch20Page() {
  ...
  const quickFilters = [
    { id: 'popular', label: 'ยอดนิยม', emoji: '🔥', type: 'popular' },
    { id: 'promotion', label: 'โปรโมชั่น', emoji: '💰', type: 'promotion' },
    { id: 'luxury', label: 'หรูหรา', emoji: '✨', type: 'luxury' },
    { id: 'family', label: 'ครอบครัว', emoji: '👨‍👩‍👧‍👦', type: 'family' },
    { id: 'nature', label: 'ธรรมชาติ', emoji: '🌿', type: 'nature' },
    { id: 'adventure', label: 'ผจญภัย', emoji: '🏔️', type: 'adventure' }
  ];
  ...
  const allSuggestions = ['ญี่ปุ่น', 'เกาหลีใต้', 'ยุโรป', 'อิตาลี', 'ฝรั่งเศส', 'สวิตเซอร์แลนด์', 'ตุรกี', 'อียิปต์', 'ดูไบ', 'ออสเตรเลีย', 'สิงคโปร์', 'มาเลเซีย', 'โตเกียว', 'โอซาก้า', 'เกียวโต', 'ปารีส', 'โรม', 'ฟลอเรนซ์', 'เวนิส', 'ซิดนีย์', 'เมลเบิร์น'];
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (showSuggestions && searchSectionRef.current) {
        ...
        // ปิดเมื่อ search section ออกจากมุมมอง (scroll ผ่านไปแล้ว)
  ...
  // Budget ranges
  const budgetRanges = [
    { label: 'น้อยกว่า 10,000 บาท', value: { min: 0, max: 9999 } },
    { label: '10,000 - 15,000 บาท', value: { min: 10000, max: 15000 } },
    { label: '15,000 - 20,000 บาท', value: { min: 15000, max: 20000 } },
    { label: '20,000 - 25,000 บาท', value: { min: 20000, max: 25000 } },
    { label: '25,000 - 30,000 บาท', value: { min: 25000, max: 30000 } },
    { label: 'มากกว่า 30,000 บาท', value: { min: 30000, max: 999999 } }
  ];
  ...
  const getBudgetDisplayText = () => {
    ...
    if (budget.min && budget.max) {
      return `${parseInt(budget.min).toLocaleString()} - ${parseInt(budget.max).toLocaleString()} บาท`;
    } else if (budget.min) {
      return `เริ่มต้น ${parseInt(budget.min).toLocaleString()} บาท`;
    } else if (budget.max) {
      return `ไม่เกิน ${parseInt(budget.max).toLocaleString()} บาท`;
    }
  ...
  const durationOptions = [
    { label: '3 วัน 2 คืน', value: '3d2n' },
    { label: '4 วัน 3 คืน', value: '4d3n' },
    { label: '5 วัน 4 คืน', value: '5d4n' },
    { label: '6 วัน 5 คืน', value: '6d5n' },
    { label: '7 วัน 6 คืน', value: '7d6n' },
    { label: '8 วัน 7 คืน', value: '8d7n' },
    { label: '9 วัน 8 คืน', value: '9d8n' },
  ...
  const filterOptions = {
    // จุดหมาย/ภูมิศาสตร์
    countries: ['ญี่ปุ่น', 'เกาหลีใต้', 'ฝรั่งเศส', 'อิตาลี', 'สวิตเซอร์แลนด์', 'ตุรกี', 'อียิปต์', 'ดูไบ', 'ออสเตรเลีย', 'สิงคโปร์', 'มาเลเซีย', 'จีน', 'อินเดีย', 'นิวซีแลนด์', 'แคนาดา', 'สหรัฐอเมริกา', 'บราซิล', 'อาร์เจนตินา', 'เปรู', 'เคนยา', 'แทนซาเนีย', 'โมร็อกโก'],
    continents: ['เอเชีย', 'ยุโรป', 'อเมริกาเหนือ', 'อเมริกาใต้', 'โอเชียเนีย', 'แอฟริกา'],
    climates: ['เมืองหนาว', 'เมืองร้อน', '4 ฤดู', 'เขตร้อนชื้น', 'ทะเลทราย', 'ภูเขาสูง'],
    
    // เวลา/ช่วงเดินทาง
    months: ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม'],
    weekdays: ['จันทร์', 'อังคาร', 'พุธ', 'พฤหัสบดี', 'ศุกร์', 'เสาร์', 'อาทิตย์'],
    festivals: ['ปีใหม่', 'สงกรานต์', 'ลอยกระทง', 'วาเลนไทน์', 'ฮาโลวีน', 'คริสต์มาส', 'ตรุษจีน', 'เทศกาลดอกซากุระ'],
    
    // ราคา/งบประมาณ
    paymentType: ['จ่ายเต็ม', 'ผ่อนชำระ', 'มัดจำ 30%', 'บัตรเครดิต', 'โอนธนาคาร'],
    ...
    airports: ['สุวรรณภูมิ (BKK)', 'ดอนเมือง (DMK)', 'เชียงใหม่ (CNX)', 'หาดใหญ่ (HDY)', 'ภูเก็ต (HKT)', 'อุดรธานี (UTH)'],
    seatClass: ['Economy', 'Premium Economy', 'Business', 'First Class'],
    stops: ['เที่ยวบินตรง', '1 ต่อเครื่อง', '2+ ต่อเครื่อง'],
    
    // ที่พัก
    hotelStars: ['3 ดาว', '4 ดาว', '5 ดาว', 'Boutique', 'Luxury Resort'],
    hotelTypes: ['โรงแรม', 'รีสอร์ท', 'บูติก', 'Local Stay', 'Airbnb', 'Hostel', 'Villa'],
    hotelLocations: ['ใจกลางเมือง', 'ชายหาด', 'ภูเขา', 'ใกล้สนามบิน', 'ย่านช้อปปิ้ง', 'ย่านประวัติศาสตร์'],
    
    // ประเภททัวร์/กลุ่มเป้าหมาย
    tourTypes: ['พักผ่อน', 'ผจญภัย', 'หรูหรา', 'ครอบครัว', 'ธรรมชาติ', 'ศิลปวัฒนธรรม', 'อาหาร', 'ช้อปปิ้ง', 'ประวัติศาสตร์', 'ศาสนา'],
    groupSizes: ['Private (1-4)', 'กลุ่มเล็ก (5-15)', 'กลุ่มกลาง (16-25)', 'กลุ่มใหญ่ (26+)'],
    guideLanguages: ['ไทย', 'อังกฤษ', 'ไทย+อังกฤษ', 'จีน', 'ญี่ปุ่น', 'เกาหลี'],
    targetAge: ['Family', 'Senior (55+)', 'Young Adult (18-35)', 'Honeymoon', 'Students', 'Business'],
    
    // กิจกรรม/ไฮไลต์
    activityTypes: ['ธรรมชาติ', 'วัฒนธรรม', 'ช้อปปิ้ง', 'อาหาร', 'ผจญภัย', 'กีฬา', 'สปา', 'ถ่ายรูป', 'เรียนรู้'],
    ...
    landmarks: ['UNESCO World Heritage', 'วัด/โบสถ์', 'พิพิธภัณฑ์', 'ตลาดท้องถิ่น', 'สวนสาธารณะ', 'ชายหาด', 'ภูเขา', 'น้ำตก', 'ถ้ำ', 'ปราสาท'],
    
    // เงื่อนไข/บริการ
    visaRequirement: ['ไม่ต้องวีซ่า', 'วีซ่าออนไลน์', 'วีซ่าปกติ', 'มีบริการขอวีซ่า'],
    meals: ['ครบทุกมื้อ', 'อาหารเช้า+เย็น', 'อาหารเช้าอย่างเดียว', 'ไม่รวมอาหาร', 'Halal Food', 'Vegetarian'],
    transport: ['รวมรถรับส่ง', 'รถโค้ชปรับอากาศ', 'รถตู้', 'รถไฟ', 'เรือ', 'ไม่รวมรถรับส่ง'],
    ...
    return (
      <article className="tour-card">
        <div className="card-image-wrapper">
          ...
          {tour.soldOut && (
            <span className="badge badge-soldout">เต็มแล้ว</span>
          )}
          {tour.seatsLeft && tour.seatsLeft <= 5 && !tour.soldOut && (
            <span className="badge badge-limited">เหลือ {tour.seatsLeft} ที่นั่ง</span>
          )}
          {/* Urgency: Live viewers indicator */}
          {!tour.soldOut && viewersCount > 10 && (
            <div className="live-viewers">
              <span className="live-dot"></span>
              <span>{viewersCount} คนกำลังดู</span>
            </div>
          )}
        </div>
        ...
        <div className="card-content">
          ...
          <div className="card-rating">
            ...
            <span className="review-count">({tour.reviews} รีวิว)</span>
            {/* Trust Signal: Best Seller */}
            {tour.reviews > 200 && (
              <span className="trust-badge bestseller">⭐ Best Seller</span>
            )}
          </div>
          ...
          {!tour.soldOut && lastBookedHours <= 3 && (
            <div className="last-booked">
              ...
              <span>จองล่าสุด {lastBookedHours} ชม.ที่แล้ว</span>
            </div>
          )}
          ...
          <div className="upsell-section">
            ...
            {hasEarlyBird && (
              <div className="early-bird">
                ...
                <span>จองล่วงหน้า 60 วัน ลด 10%</span>
              </div>
            )}
            ...
            {hasGroupDiscount && (
              <div className="group-discount">
                ...
                <span>4 ท่านขึ้นไป ลดเพิ่ม 5%</span>
              </div>
            )}
            
            <div className="payment-options">
              <span className="payment-badge">💳 ผ่อน 0% 3 เดือน</span>
              <span className="payment-badge">✅ การันตีคืนเงิน</span>
            </div>
          </div>
          ...
          <div className="card-price">
            <div className="price-wrapper">
              {tour.originalPrice && (
                <>
                  <span className="price-original">฿{tour.originalPrice.toLocaleString()}</span>
                </>
              )}
              <span className="price-current">
                <span className="price-label">เริ่มต้น</span>
                <span className="price-amount">฿{tour.price.toLocaleString()}</span>
                <span className="price-unit">/ท่าน</span>
              </span>
              <span className="price-tax">
                {tour.includesTax ? 'รวมภาษีแล้ว' : 'ยังไม่รวมภาษี'}
              </span>
            </div>
          </div>
    ...
    <>
      <style jsx global>{`
        ...
        .flash-sale-timer::before {
          ...
          animation: flashShimmer 2.5s ease-in-out infinite;
        }

        .flash-icon {
          font-size: 16px;
          animation: flashIconBounce 1s ease-in-out infinite;
        }
        ...
        .btn-urgent {
          ...
          animation: noticeablePulse 2s ease-in-out infinite;
          position: relative;
          overflow: hidden;
        ...
        .btn-urgent::before {
          ...
          animation: visibleShimmer 3s ease-in-out infinite;
        }
      ...
      <main className="tour-search-20">
                  ...
                  <div className="date-picker">
                    <div className="date-picker-header">
                      ...
                      <div className="date-picker-type">
                        {selectedDateType === 'start' ? 'เลือกวันเริ่มต้น' : 'เลือกวันสิ้นสุด'}
                      </div>
                    </div>
        ...
        <section className="results-section">
          ...
          <div className="results-toolbar">
            <div className="toolbar-content">
              <div className="toolbar-left">
                <span className="results-count">พบ {filteredTours.length} ทัวร์</span>
                <div className="sort-dropdown">
                  ...
                  >
                    ...
                    <option value="departure">ออกเดินทางเร็วสุด</option>
                  </select>
          ...
          {filteredTours.length === 0 && !loading && (
            <div className="empty-state">
              ...
              <h2 className="empty-title">ไม่พบทัวร์ที่ตรงกับการค้นหา</h2>
              <p className="empty-description">
                ลองปรับเปลี่ยนเงื่อนไขการค้นหาหรือล้างฟิลเตอร์เพื่อดูทัวร์ทั้งหมด
              </p>
          ...
          <div className="compare-bar">
            <div className="compare-bar-content">
              ...
              <div className="compare-actions">
                ...
                >
                  เปรียบเทียบตอนนี้ ({compareList.length})
                </button>
              </div>
            </div>
          </div>
        ...
        >
          <div className="filter-header">
            <h2 className="filter-title">ฟิลเตอร์ขั้นสูง</h2>
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-body">
                ...
                <div style={{ marginTop: 'var(--space-4)' }}>
                  <p><strong>ราคาเริ่มต้น:</strong> ฿{quickViewTour.price.toLocaleString()}/ท่าน</p>
                  <p><strong>ระยะเวลา:</strong> {quickViewTour.duration}</p>
                  <p><strong>ช่วงเดินทาง:</strong> {quickViewTour.departureMonths}</p>
                  <p><strong>สายการบิน:</strong> {quickViewTour.airline}</p>
                  <div style={{ marginTop: 'var(--space-4)', display: 'flex', gap: 'var(--space-2)' }}>
                    <button className="btn btn-secondary">ดูรายละเอียดเต็ม</button>
                    <button className="btn btn-primary">จองเลย</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        {showCompareSheet && (
          <div className="modal-overlay" onClick={() => setShowCompareSheet(false)}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '1200px' }}>
              <div className="modal-header">
                <h2 className="modal-title">เปรียบเทียบทัวร์</h2>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ borderBottom: '2px solid var(--color-border)' }}>
                        <th style={{ padding: 'var(--space-2)', textAlign: 'left' }}>ชื่อทัวร์</th>
                        <th style={{ padding: 'var(--space-2)', textAlign: 'center' }}>ราคา</th>
                        <th style={{ padding: 'var(--space-2)', textAlign: 'center' }}>ระยะเวลา</th>
                        <th style={{ padding: 'var(--space-2)', textAlign: 'center' }}>เรตติ้ง</th>
                        <th style={{ padding: 'var(--space-2)', textAlign: 'center' }}>การดำเนินการ</th>
                      </tr>
                    </thead>
                    <tbody>
                      {compareList.map((tourId) => {
                        ...
                        return tour ? (
                          <tr key={tourId} style={{ borderBottom: '1px solid var(--color-border)' }}>
                            ...
                            <td style={{ padding: 'var(--space-2)', textAlign: 'center' }}>฿{tour.price.toLocaleString()}</td>
                            ...
                            <td style={{ padding: 'var(--space-2)', textAlign: 'center' }}>
                              <button className="btn btn-primary btn-sm">จองเลย</button>
                            </td>
                          </tr>
                        ) : null;
                      })}
